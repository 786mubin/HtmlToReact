...
const Sidebar = () => {
    var sidebar = useContext(SideNavBar);

    var { sideNav, setSideNav } = sidebar;
    return (
        <>
            <nav className="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                ...
                {/* Sidebar Toggle*/}
                <button onClick={() => setSideNav(!sideNav)} className="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i className="fas fa-bars" /></button>
                {/* Navbar Search*/}
